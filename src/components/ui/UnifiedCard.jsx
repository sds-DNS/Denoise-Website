export default function UnifiedCard({ children, className = "", accent = "top" }) {
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl border border-brand/10 bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:border-brand/30 hover:shadow-brand-card ${className}`}>
