      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid items-stretch gap-12 lg:grid-cols-[.9fr_.8fr]">
          <div className="flex h-full max-w-3xl flex-col">
            ...
            <SectionHeading>
              We turn operational ambiguity into structured execution.
            </SectionHeading>
            <p className="mt-6 text-lg leading-8 text-muted">
              DENOISE analyzes how a company actually functions beneath the surface and converts
              that understanding into clear operational decisions, systems, and execution
              structures.
            </p>
            <div className="mt-6 grid flex-1 auto-rows-fr gap-3 md:grid-cols-2">
              {deliverables.map(({ icon: Icon, title, text }) => (
                <motion.div
                  ...
                  variants={fadeUp}
                >
                  <UnifiedCard accent="left" className="flex h-full flex-col p-4 pl-6">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-x-3 gap-y-1 text-xl font-semibold leading-8 text-ink">
          <span>We do not deliver generic consulting reports.</span>
          <GoldNote>We deliver operational clarity with implementation direction.</GoldNote>
        </div>
      </div>
    </section>
  );
