...
export default function Insights() {
  return (
    <section id="insights" className="bg-[#F9F6FF] px-6 py-24 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid items-stretch gap-12 lg:grid-cols-[.72fr_.98fr]">
          <div className="flex h-full flex-col pt-1">
            <SectionLabel>Insights</SectionLabel>
            <h2 className="text-4xl font-black tracking-[-0.04em] text-[#17131F] md:text-5xl">Operational insights.</h2>
            <p className="mt-6 max-w-xl text-lg leading-8 text-[#4A4654]">We believe operational knowledge should compound across the industry. DENOISE shares practical insights, operational thinking, and implementation lessons gathered through working directly with scaling companies and complex execution environments.</p>
            <a href="#" className="mt-7 inline-block text-sm font-bold text-[#5B2EFF] transition hover:text-[#9E7A16]">View all insights</a>
