        ...
        <div className="grid items-stretch gap-14 lg:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="flex h-full flex-col self-stretch">
            <div>
              ...
              <h2 className="text-4xl font-black tracking-[-0.04em] text-ink md:text-5xl">Growth without operational structure creates hidden instability.</h2>
              <div className="mt-7 space-y-5 text-lg leading-8 text-muted"><p>Most companies focus on outcomes while remaining blind to how execution actually functions internally. Revenue may grow. Teams may expand. But without operational clarity, complexity compounds faster than leadership can manage it.</p><p>DENOISE was created to solve that gap. We believe operational structure should create visibility, accountability, and predictable execution, not additional bureaucracy.</p></div>
            </div>
            <div className="mt-6 flex flex-wrap items-center gap-x-3 gap-y-1 text-xl font-semibold leading-8 text-ink"><span>The goal is not to add process.</span><span className="text-gold">The goal is to remove operational noise.</span></div>
          </div>
        </div>
      </div>
    </section>
